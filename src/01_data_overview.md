...
|----------|-------------|-------------------------|
| Crime | ASSAULT, BURGLARY, DISORDERLY, LARCENY, OTHER CRIMES, OTHER-CRIME INCIDENT, ROBBERY, SEX OFFENDER, HA ADDRESS VERIFY | 815,867 |
| Potential Crime | ALARMS, DISPUTE, EXPLOSIVE DEVICE OR THREAT, INVESTIGATE/POSSIBLE CRIME, PANIC ALARM, PO/SECURITY HOLDING SUSPECT, SHOT SPOTTER, SUSP LETTER, SUSP PACKAGE, SUSP SUBSTANCE | 1,117,591 |
